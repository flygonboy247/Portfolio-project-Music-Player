...
- **Due Date**: <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->3/1
...
- [ y] I have expressed my choice of design and why in the "Pre-Assignment" section
- [ ] I have created a proof-of-concept of my design
  - [ y] I have created a new Java file in `src`
  - [ y] I have defined my representation using a field or fields
  - [ y] I have implemented a few methods from my design
  - [ y] I have shown that the methods work through a main method
...
I want to code the Music Player Componets as I think its my most thought out design that can
probobly be created without spending an unreasonable amount of time and only using OSU componets
...
Actually created a working proof of concept using an array rather than
a complicated mess of Mapping with backslashes to separate data