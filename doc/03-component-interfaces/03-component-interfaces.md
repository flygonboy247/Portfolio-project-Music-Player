...
- **Due Date**: <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->3/8
...
```java
public interface Point3DKernel extends Standard<   > {
   ...
}
```
...
From the proof of concept I got rid of the array storing the store data to using
Song Nodes to store datas becasue thats what my componet is made for as well as
finishing adding all methods I  wantto add now that I proved the concept of the
componet
## Assignment Tasks
...
got rid of method bodys
also added how I imporved from part 2