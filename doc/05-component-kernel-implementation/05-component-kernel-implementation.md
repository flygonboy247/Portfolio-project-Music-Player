...
- **Due Date**: <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->4/5
...
My componet doesn't have a representation as I created my own data structure
however it is like a queue except holding more information in each node and
is modified like a linked list. This is because although its heavily like linked
list there is a modification in the head that makes it like a linked list in a
queue.
