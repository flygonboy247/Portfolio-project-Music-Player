...
- **Name**: <!-- TODO: fill with first and last name (e.g., Brutus Buckeye) and delete this comment -->jian wang
- **Dot Number**: <!-- TODO: fill with OSU dot number (e.g., buckeye.17) and delete this comment -->wang.17034
- **Due Date**: <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->4/19
...
<!-- TODO: discuss -->
I think I now better understand how the componets are structured(differences
between kernal, componet1, and secondary) but also better understand why they
run as they do(was always annoyed about why queue and stack didn't work as I
wanted it to even when I knew the conventions). Due to this I think I now better
understand software development more than just rewriting written code but
...
<!-- TODO: discuss -->
Yes, although learning and using componets is hard, creating one was a chalenge
I wasn't expecting as I had to learn how code works in a data stucture more
ex removeSong having to delete a Song node anywhere in the MusicPlayer. I
addressed this by going to office hours and using the internet.
...
<!-- TODO: discuss -->
Definatly should have stayed on the scedual to keep the pace, however this project
was definatly one of my favorite(and most challanging) projects as I had free
reign over how I did everything(including the deadlines which I should have
stuck to). This allowed me to try stuff out and figure out how things worked
rather than asking a friend or used the internet to find the answer.
...
<!-- TODO: discuss -->
Although I may have picked up skills other than software skills, by doing this
project my understanding of how data structures work and funtion have improved a
lot as I not only know from a theory perspective but also have tried implimenting
a similar componet to store data.

> The follow-up question is: could you rephrase these skills you picked up
> as bullet points that you could put on a resume? Try it below.
<!-- TODO: discuss -->
-data structues skills, how they might work and what they could do
-general programming skills, better at writing coding

> Next, how has working on this project affected your career trajectory?
> In other words, do you now hate the topic you picked? Or, are you even more
> interested in it? Both outcomes are valuable to your personal development.
<!-- TODO: discuss -->
Although I dont think I'll want to write componets like this as a carrer, I
definatly don't dislike doing it, it was fun trying stuff out(although
failure was bad having the freedom to do whatevver I wanted and try stuff was
fun). I'm definatly intrested in learning more about data structures(already
known and new ones that pop up) as I find it intresting, although I probobly
wouldn't try seriously creating one without a need for it or for fun.
...
<!-- TODO: discuss -->
I still have no Idea what my current career trajectory is as im still undecided
on what specialty I should go in. However I have friends that have graduated
in CSE that would probobly be fine with mentoring me if I have any problems.
